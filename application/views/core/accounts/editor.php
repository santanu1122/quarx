                ...
                <div id="formHolder" class="raw100 form">
                    ...
                    <form method="post" enctype="multipart/form-data" action="<?php echo site_url('accounts/profile_editor'); ?>">
                        ...
                        <div class="raw100">
                            ...
                            <div class="raw66"><?php echo $profile->user_name; ?></div>
                        </div>
                    ...
                    <?php } ?>
                        <button data-theme="e" onclick="deleteConfirm(<?php echo $profile->user_id; ?>)">DELETE ACCOUNT</button>
...
<script type="text/javascript">
    setTimeout(profileImageResize, 400);
</script>
