...
***************************************************************/
    ...
    {
        $query = $this->db->query("SELECT * FROM img_collections WHERE collection_id = ".$this->db->escape($id));
    ...
    {
        $sql = "UPDATE img SET `favorite` = 0 WHERE blog_id = ".$this->db->escape($blog_id)." || blog_id = 0";
        $qry = $this->db->query($sql);
        if($qry)
        {
            $query = "UPDATE img SET `favorite` = 1 WHERE img_id = ".$this->db->escape($id);
...
***************************************************************/
    ...
    {
        $query = $this->db->query("DELETE FROM img WHERE img_id = ".$this->db->escape($id));
        if($query)
        {
            return true;
        }
