...
class gallery_categories extends MX_Controller {
...
*************************************/
    function check_title(){
        if($_POST){
            ...
            $qry = $this->model_gallery_categories->check_title($_POST['cat_name']);
...
*************************************/
    function add($type){
        if($_POST){
            $this->load->model('model_gallery_categories');
            $qry = $this->model_gallery_categories->add_category($_POST['cat_name'], $_POST['cat_parent']);
...
*************************************/
    function delete($type){
        if($_POST){
            $this->load->model('model_gallery_categories');
            $qry = $this->model_gallery_categories->delete_category($_POST['cat_id']);
...
*************************************/
    function view(){
        $this->load->model('model_gallery_categories');
        $categories = $this->model_gallery_categories->get_all_cats();
