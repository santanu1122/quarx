...
class event_categories extends MX_Controller {

/* Check for Duplicates 
*************************************/
    function check_title(){
        if($_POST){
            $this->load->model('model_event_categories');
            $qry = $this->model_event_categories->check_title($_POST['cat_name'], "events");
...
*************************************/
    function add($type){
        if($_POST){
            $this->load->model('model_event_categories');
            $qry = $this->model_event_categories->add_category($_POST['cat_name'], $_POST['cat_parent']);
...
*************************************/
    function delete($type){
        if($_POST){
            $this->load->model('model_event_categories');
            $qry = $this->model_event_categories->delete_category($_POST['cat_id']);
...
*************************************/
    function view(){
        $this->load->model('model_event_categories');
        $categories = $this->model_event_categories->get_all_cats();
